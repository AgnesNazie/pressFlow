...
import se.lexicon.pressflow.service.TodoService;
import se.lexicon.pressflow.service.UserService;
...
public class TodoController {
    ...
    @Operation(summary = "Assign todo to user")
    @PostMapping("/{todoId}/assign")
    @ResponseStatus(HttpStatus.CREATED)
    public void assignTodo(
            @PathVariable Long todoId,
            @Valid @RequestBody TodoAssignmentDto dto
    ) {
        todoService.assignTodo(todoId, dto);
    }
